...
public class OrdTopologica {
    public <T extends Comparable<T>> void OrdenarTopol(Grafo<T> g, String inicio){
        ...
        Vertice<T> root;
        root = OrdTopologica.pegarRoot(g,inicio);
        //ArrayList <Vertice<T> > visita;
        ArrayList<Vertice<T> > aux = b.DFS(g, root,inicio);
        
        OrdTopologica.sort(aux);
        Collections.reverse(aux);
        System.out.println(" =========== Printando a Ordem Topologica Valida a partir de "+ inicio+" como root =============");
